...
public interface ServiceRecord {
	 ...
	 *
	 * @param requiredSecurity determines whether authentication or encryption are required
	 *                         for a connection
	 * @param mustBeMaster     {@code true} indicates that this device must play the role of
	 ...
	 * specification
	 * @throws java.lang.IllegalArgumentException if requiredSecurity is not one of the constants
	 ...
	 * @throws java.lang.IllegalArgumentException if {@code classes} is not an OR of one or more of the major
	 ...
	 * @param attrValue the {@link javax.bluetooth.DataElement} which is the value of
	 ...
	 * @throws java.lang.IllegalArgumentException if {@code attrID} does not represent a 16-bit unsigned
	 *                                            integer; if {@code attrID} is the value of
	 *                                            {@code ServiceRecord}Handle (0x0000)
	 * @throws java.lang.RuntimeException         if this method is called on a {@code ServiceRecord} that was
